...
public class CandyMachine extends UnicastRemoteObject implements CandyMachineRemote{
	...
	private State state;
	private int count = 0;
	private String location; // 加入糖果自动售卖机的位置
	
	public CandyMachine(String loc, int count) throws RemoteException {
		super();
	...
	public CandyMachine(int count) throws RemoteException {
		soldOutState = new SoldOutState(this);
		soldState = new SoldState(this);
		hasQuarterState = new HasQuarterState(this);
		noQuarterState = new NoQuarterState(this);
